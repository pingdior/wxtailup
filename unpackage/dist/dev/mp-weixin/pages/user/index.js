...
/***/ 197:
/*!*********************************************************************!*\
  !*** /Users/chenping/7 kalastar/tailup/uniapp/pages/user/index.vue ***!
  \*********************************************************************/
...
/***/ 198:
/*!****************************************************************************************************!*\
  !*** /Users/chenping/7 kalastar/tailup/uniapp/pages/user/index.vue?vue&type=template&id=137d5072& ***!
  \****************************************************************************************************/
...
/***/ 199:
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/chenping/7 kalastar/tailup/uniapp/pages/user/index.vue?vue&type=template&id=137d5072& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 200:
/*!**********************************************************************************************!*\
  !*** /Users/chenping/7 kalastar/tailup/uniapp/pages/user/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 201:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/chenping/7 kalastar/tailup/uniapp/pages/user/index.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
...
var api = __webpack_require__(/*! ../../utils/api/index */ 10);var _default = { name: "Details", components: {// wBreadcrumb,
  }, data: function data() {return { userId: 0, // 用户id 如果和store一样，就是本人， 否则是其他人
      userInfo: { createTime: "2021-08-01 20:53:51", donate: false, headImgUrl: "https://thirdwx.qlogo.cn/mmopen/vi_32/POgEwh4mIHO4nibH0KlMECNjjGxQUq24ZEaGT4poC6icRiccVGKSyXwibcPq4BWmiaIGuG1icwxaQX6grC9VemZoJ8rg/132", id: 5, ip: "223.85.176.189", isEnable: true, latitude: null, longitude: null, nickName: "微信测试用户", openId: "oH14d427JdkiMcPqDYkZF9StI8_M", phone: null, score: 0, sex: 0, type: 0, unionId: null, updateTime: "2021-08-01 20:53:51", wxNumber: null }, userExtraData: { imageIds: [], phone: "", wxNumber: "" }, defaultBanners: ["../../static/images/banner/banner1.jpg"], indicatorDots: true, vertical: false, autoplay: false, interval: 2000, duration: 500, active: 0, userHomeData: { animalBriefs: [], baseBriefs: [], chargeBriefs: [], canNum: 0, focused: false, // 关注
        imageIds: [], user: {}, fanNum: 0, followNum: 0 } };}, computed: _objectSpread(_objectSpread({}, (0, _vuex.mapState)({ appUserInfo: function appUserInfo(state) {return state.user.userInfo;} })), {}, { banners: function banners() {return this.userExtraData.imageIds.length ? this.userExtraData.imageIds : this.defaultBanners; // return this.userHomeData.imageIds.length
      //   ? this.userHomeData.imageIds
      //   : this.defaultBanners;
    }, // 是否是本人
    // 没有传入userId 或者传了且和store一样 都是本人
    isSelf: function isSelf() {return !this.userId || this.userId && this.userId === this.appUserInfo.id;}, reverseChargeBriefsList: function reverseChargeBriefsList() {if (this.userHomeData && this.userHomeData.chargeBriefs) {return this.userHomeData.chargeBriefs.reverse();}} }), methods: { initData: function initData() {this.getUserHomeInfo();this.getUserInfo();}, onChange: function onChange(event) {if (event.target.title == "毛窝") {console.log("enter onchange", event);this.getUserHomeInfo();}}, toFocus: function toFocus() {var _this = this;api.userFocus({ userId: this.userId }).then(function (res) {console.log("关注", res);_this.userHomeData.focused = !_this.userHomeData.focused;uni.showToast({ title: _this.userHomeData.focused ? "关注成功" : "取消关注" });});}, toEdit: function toEdit(item) {console.log(item);uni.navigateTo({ url: "/pages/user/editForm", success: function success(s) {console.log("s", s);}, error: function error(e) {console.log("e", e);}, complete: function complete(c) {console.log("c", c);} });}, // methods
    // 获取用户主页信息
    // 如果有userId
    getUserHomeInfo: function getUserHomeInfo() {var _this2 = this;console.log("get user home");var params = {};if (!this.isSelf) {params.userId = this.userId;}api.getUserHomeInfo(params).then(function (res) {_this2.userHomeData = res.result;console.log("getUserHomeData:", _this2.userHomeData);_this2.userInfo = _this2.userHomeData.user;});}, // 获取用户其他信息
    getUserInfo: function getUserInfo() {var _this3 = this;api.getUserInfo().then(function (res) {var result = res.result;console.log("用户信息", result);if (result.imageIds.length) {result.imageIds = res.result.imageIds.map(function (item) {return item;});}_this3.userExtraData = result;});}, // 去动物详情
    toAnimal: function toAnimal(item) {uni.navigateTo({ url: "/subPackages/animal/details?id=" + item.id });}, // 组织详情页
    toOrganization: function toOrganization(item) {console.log("org", item);uni.navigateTo({ url: "/subPackages/organization/details?id=" + item.id });}, // 成为月捐人
    toDonateMonth: function toDonateMonth() {uni.showToast({ title: "设置成功" });}, // 新增机构
    toAddBase: function toAddBase() {console.log(1);uni.navigateTo({ url: "/subPackages/organization/editForm" });} }, /**
                                                                                                                        * 生命周期函数--监听页面加载
                                                                                                                        */mounted: function mounted() {this.initData();}, onShow: function onShow() {this.getUserHomeInfo();}, onLoad: function onLoad(options) {if (options.userId) {this.userId = options.userId;}} };exports.default = _default;
...
/***/ 202:
/*!******************************************************************************************************!*\
  !*** /Users/chenping/7 kalastar/tailup/uniapp/pages/user/index.vue?vue&type=style&index=0&lang=css& ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 203:
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!/Users/chenping/7 kalastar/tailup/uniapp/pages/user/index.vue?vue&type=style&index=0&lang=css& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
